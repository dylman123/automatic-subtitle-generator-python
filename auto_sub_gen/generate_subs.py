...
def review_captions(csv_path, video_path):
    '''
    ...
    Opens captions in default csv editor. Opens video clip in default video player.
    '''
    from tkinter import LEFT  # For GUI rendering
    ...
    render.draw_next()  # Draw button
    open_file(video_path)  # Playback video
    open_file(csv_path)  # Open temp/subtitles.csv for review
